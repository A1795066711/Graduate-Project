        ...
        for file_set_type in file_set_type_list:
            ...
            if file_set_type == "train":
                ...
                if self.Competition_Mode == True:
                    path_to_raw_data_file = "test.csv"
                else:
                    path_to_raw_data_file = "dev.csv"
            print( '3' + '\n' )
            ...
            model , lexicon , max_len = bilstm__cnn_crf.bilstm__cnn_crf.tokenizer( 0 )
...
#                        ttnu = tt#bilstm__cnn_crf.bilstm__cnn_crf.tokenizer( text ).split( ' ' )
                        text_tokened = list( tt.lower() )

#                        so_tokened = text_tokened
#                        r = []
#                        set = -1
...
#                        text_tokened = r
                        ...
                        print( text_tokened )
                        text_tokened_not_UNK = text_tokened#self.bert_tokenizer.tokenize_not_UNK(ttnu)
#                        print( bilstm__cnn_crf.bilstm__cnn_crf.tokenizer( text ).split( ' ' ) )
                        if (not self.Competition_Mode) or file_set_type in ["train", "valid"]:
