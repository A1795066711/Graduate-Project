...
#	text=''
#	for i in range(10):
#		text+='2009年11月10日，大型水电工程伊泰普坝供电系统突然瘫痪，巴西能源部官员称暴风雨毁坏了几个变电站切断了世界上第二大水电站的供电系统导致了这次停电。大约三分之一的巴西人口陷入了4个小时的停电事故，包括巴西的两个最大城市，巴拉圭全国陷入了停电事故，波及并使6700万人处于停电状态。'        
...
#	fenci_by_file('test_documents/test_1','test_documents/test_1_mine',model,lexicon,max_len)
	return model , lexicon , max_len#splitText
