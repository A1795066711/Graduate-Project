...
class SKE_2019_Multi_Label_Classification_Processor(DataProcessor):
    ...
    def get_examples(self, data_dir):
        with open(os.path.join(data_dir, "token_in.txt"), encoding='utf-8-sig') as token_in_f:
            with open(os.path.join(data_dir, "predicate_out.txt"), encoding='utf-8-sig') as predicate_out_f:
    ...
    def get_test_examples(self, data_dir):
        with open(os.path.join(data_dir, os.path.join("test", "token_in.txt")), encoding='utf-8-sig') as token_in_f:
            token_in_list = [seq.replace("\n", '') for seq in token_in_f.readlines()]
    ...
    def _create_example(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            if set_type == "test":
                text_str = line
                predicate_label_str = '事故发生时间'#'事故开始时间'
            else:
                text_str = line[0]
